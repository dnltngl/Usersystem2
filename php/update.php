...
if (isset($_GET['id'])) {
    ...
    $mobile = validate($_POST['mobile']); // Added mobile field
    $gender = validate($_POST['gender']); // Added gender field
    ...
    if (empty($name)) {
        ...
        header("Location: ../update.php?id=$id&error=Mobile number is required");
